  ...
  var Utils = function () {
    ...
    Utils.prototype.getEnvironment = function () {
      ...
      if ( ! _utils_.ENVIRONMENT.DEPRECATED_BROWSER_FLAG ) {
        ...
        _utils_.ENVIRONMENT.BROWSER = get_browser();
    ...
    //restituisce il browser corrente controllando lo user agent, non molto affidabile comunque percjè lato js

    var get_browser = function () {

      //https://gist.github.com/ticky/3909462
